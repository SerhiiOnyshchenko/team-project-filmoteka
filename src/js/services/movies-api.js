...
// FT-10
export function fetchFilmsByName(searchText, page=1) {
    const url = `${BASE_URL}search/movie?api_key=${MY_KEY}&language=en-US&query=${searchText}&page=${page}&include_adult=false` ;
    // 
