...
btnEn.addEventListener('click', en);
 ...
 function ua (){
   btnEn.disabled = false;
    ...
    comandItemCardText1.textContent = "Реєстрація/автентифікація користувача через Firebase"; 
    comandItemCardText2.textContent = "Підвантаження акторів,інформації про акторів";
    comandItemCardText3.textContent = "Запис параметрів пошуку в URL та зчитування при перезагрузці";
    comandItemCardText4.textContent = "Пошук за жанром"; 
    comandItemCardText5.textContent = "Світла/темна тема";
    comandItemCardText6.textContent = "Верстка хедера для головної/my library сторінок"; 
    comandItemCardText7.textContent = "Пошук та відображення фільмів за ключовим словом"; 
    ...
    comandItemCardText13.textContent = "Підключення spinner для асинхронних запитів"; 
    comandItemCardText14.textContent = "Відображення головної сторінки після натискання на логотип/Home/"; 
    ...
    comandItemCardText20.textContent = "Закриття модалки за натисканням на клавішу ESC та за кліком"; 
    comandItemCardText21.textContent = "Додавання динамічно підставленою інформацією про фільм за натисканням картки з фільму"; 
    comandItemCardText22.textContent = "Верстка контейнера сторінки 'My Library'" 
    comandItemCardText23.textContent = 'За натисканням на "Watched" показуються переглянуті фільми' 
    comandItemCardText24.textContent = 'За натисканням на "Queue" показуються фільми додані в чергу' 
    comandItemCardText25.textContent = 'Верстка шаблону модалки одного фільму'; 
    comandItemCardText26.textContent = "Підвантаження популярних фільмів на головну сторінку" 
    comandItemCardText27.textContent = "ЗМІНА МОВИ" 
    comandItemCardText28.textContent = "При переході на кожну сторінку малювати відповідну частину фільмів";
...
function en () {
 ...
 comandItemCardText1.textContent = "User registration / authentication via Firebase"; 
 comandItemCardText2.textContent = "Loading actors, information about actors";
 comandItemCardText3.textContent = "Record search parameters in the URL and read on reboot";
 comandItemCardText4.textContent = "Search by genre"; 
 comandItemCardText5.textContent = "Dark mode";
 comandItemCardText6.textContent = "Header layout for main and my library pages"; 
 ...
 comandItemCardText13.textContent = "Spinner connection for asynchronous queries"; 
 comandItemCardText14.textContent = "Display the home page after clicking on the Home / logo"; 
 ...
 comandItemCardText20.textContent = "Close the modal by pressing the ESC key and clicking"; 
 comandItemCardText21.textContent = "Add dynamically based movie information by tapping a movie card"; 
 comandItemCardText22.textContent = "My Library page container layout"; 
 comandItemCardText23.textContent = 'Clicking on "Watched" shows watched movies'; 
 comandItemCardText24.textContent = 'Clicking on "Queue" shows movies added to the queue.'; 
 ...
 comandItemCardText28.textContent = "When going to each page, draw the appropriate part of the movies";
