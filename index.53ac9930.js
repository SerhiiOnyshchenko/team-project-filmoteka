 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Be;Be="",Pe(new J("platform-logger",(e=>new Ee(e)),"PRIVATE")),Pe(new J("heartbeat",(e=>new qe(e)),"PRIVATE")),Me("@firebase/app","0.7.26",Be),Me("@firebase/app","0.7.26","esm2017"),Me("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ht(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Ft(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Vt(t))return"Blackberry";if(Bt(t))return"Webos";if(jt(t))return"Safari";if((t.includes("chrome/")||qt(t))&&!t.includes("edge/"))return"Chrome";if(Wt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Ft(e=y()){return/firefox\//i.test(e)}function jt(e=y()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function qt(e=y()){return/crios\//i.test(e)}function Ht(e=y()){return/iemobile/i.test(e)}function Wt(e=y()){return/android/i.test(e)}function Vt(e=y()){return/blackberry/i.test(e)}function Bt(e=y()){return/webos/i.test(e)}function zt(e=y()){return/iphone|ipad|ipod/i.test(e)}function $t(){return T()&&10===document.documentMode}function Gt(e=y()){return zt(e)||Wt(e)||Bt(e)||Vt(e)||/windows phone/i.test(e)||Ht(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Bs(e){return{type:"value",snapshotNode:e}}function zs(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function $s(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Gs(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Wa{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Va(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||os(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Ba(e,t,n){Va(e,n),za(e,(e=>as(e,t)||as(t,e)))}function za(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?($a(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function $a(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();lr&&dr("event: "+n.toString()),kr(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
